...
Python. See `README.md` for the layout of the tooling and what each piece
does.

## Conventions

- Scripts are Python 3 with minimal dependencies; anything that must run in
  CI stays dependency-light or vendored.
